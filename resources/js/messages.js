...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, initializing MessageHandler');
    try {
        window.messageHandler = new MessageHandler();
        console.log('MessageHandler initialized and assigned to window.messageHandler');
    } catch (error) {
...
if (document.readyState === 'loading') {
    ...
    console.log('DOM already ready, initializing MessageHandler immediately');
    try {
        window.messageHandler = new MessageHandler();
        console.log('MessageHandler initialized immediately');
    } catch (error) {
        console.error('Error initializing MessageHandler immediately:', error);
    }
}
